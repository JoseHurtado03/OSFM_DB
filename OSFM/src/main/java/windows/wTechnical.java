...
import osfm.Technical;

/**
 *
 * @author hvjos
 */
public class wTechnical extends javax.swing.JFrame {
    ...
    public wTechnical() {
        ...
        Technical admi = new Technical();
        admi.showTechnicals(tableTech);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Personal Técnico");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 30, -1, 40));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 200, -1, -1));
        jPanel1.add(city, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 200, 240, -1));
        ...
        jPanel1.add(urba, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 250, 210, -1));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista del Personal Técnico", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel2.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        tableTech.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        ...
        tech.insertTech(Integer.parseInt(dni.getText()), name.getText(), birth.getText(), startDate.getText(), email.getText(), emailIns.getText(), tlf.getText(), city.getText(), urba.getText());
        tech.showTechnicals(tableTech);
        dni.setText("");
        name.setText("");
        birth.setText("");
        startDate.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wTechnical.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new wTechnical().setVisible(true);
            }
        });
    }
